        ...
        return (
                ...
                <div className="card-body">
                    ...
                    <table className="table table-hover">
                        ...
                        <p></p>
                        <p>
                            <input placeholder="Find Reports by Title" className="form-control" name="title" type="text" onChange={this.handleTitleOnChange}></input> 
                            {/*<Link to={`/report/title?title=${this.state.title}`} className="btn btn-primary">Find reports with title</Link>*/}
                            <button onClick={this.handleFindByTitleRequest} className="btn btn-warning mt-4">Enter</button>
                        </p>
